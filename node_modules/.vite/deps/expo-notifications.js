import {
  ...
  Platform_default
} from "./chunk-N3SUFAFL.js";
import "./chunk-Q5US7UQ5.js";
import "./chunk-4IVSI7TS.js";
import {
  require_react
...
// node_modules/@ide/backoff/build/backoff.js
var require_backoff = __commonJS({
  "node_modules/@ide/backoff/build/backoff.js"(exports) {
    "use strict";
    ...
    function computeNextBackoffInterval2(initialBackoff, previousRetryCount, { multiplier = 1.5, randomizationFactor = 0.25, minBackoff = initialBackoff, maxBackoff = Infinity } = {}) {
    ...
    exports.computeNextBackoffInterval = computeNextBackoffInterval2;
  }
});
...
function ensureNativeModulesAreInstalled() {
  ...
  try {
    if (Platform_default.OS === "web") {
      ...
      (_a3 = NativeModules_default.ExpoModulesCore) == null ? void 0 : _a3.installModules();
    }
  } catch (error) {
...
// node_modules/expo-modules-core/build/NativeModule.js
...
// node_modules/expo-modules-core/build/SharedObject.js
ensureNativeModulesAreInstalled();
var SharedObject_default = globalThis.expo.SharedObject;
...
// node_modules/expo-modules-core/build/uuid/lib/bytesToUuid.js
var byteToHex = [];
for (let i = 0; i < 256; ++i) {
...
// node_modules/expo-modules-core/build/uuid/uuid.types.js
var Uuidv5Namespace;
(function(Uuidv5Namespace2) {
...
// node_modules/expo-modules-core/build/uuid/uuid.js
var _a;
var nativeUuidv4 = (_a = globalThis == null ? void 0 : globalThis.expo) == null ? void 0 : _a.uuidv4;
var _a2;
var nativeUuidv5 = (_a2 = globalThis == null ? void 0 : globalThis.expo) == null ? void 0 : _a2.uuidv5;
function uuidv4() {
  if (!nativeUuidv4) {
...
function uuidv5(name2, namespace) {
  ...
  return nativeUuidv5(name2, parsedNamespace);
}
var uuid = {
  v4: uuidv4,
  v5: uuidv5,
...
function requireOptionalNativeModule(moduleName) {
  var _a3, _b;
  ensureNativeModulesAreInstalled();
  return ((_b = (_a3 = globalThis.expo) == null ? void 0 : _a3.modules) == null ? void 0 : _b[moduleName]) ?? NativeModulesProxy_default[moduleName] ?? null;
}
...
// node_modules/expo-modules-core/build/Refs.js
var import_react2 = __toESM(require_react());

// node_modules/expo-modules-core/build/hooks/useReleasingSharedObject.js
...
// node_modules/expo-notifications/build/getDevicePushTokenAsync.js
var nativeTokenPromise = null;
async function getDevicePushTokenAsync() {
  if (!PushTokenManager_default.getDevicePushTokenAsync) {
  ...
  if (nativeTokenPromise) {
    ...
    nativeTokenPromise = PushTokenManager_default.getDevicePushTokenAsync();
    devicePushToken = await nativeTokenPromise;
    nativeTokenPromise = null;
  }
  return { type: Platform_default2.OS, data: devicePushToken };
}
...
// node_modules/expo-application/build/ExpoApplication.js
var ExpoApplication_default = requireNativeModule("ExpoApplication");

// node_modules/expo-application/build/Application.js
var nativeApplicationVersion = ExpoApplication_default ? ExpoApplication_default.nativeApplicationVersion || null : null;
var nativeBuildVersion = ExpoApplication_default ? ExpoApplication_default.nativeBuildVersion || null : null;
var applicationName = ExpoApplication_default ? ExpoApplication_default.applicationName || null : null;
var applicationId = ExpoApplication_default ? ExpoApplication_default.applicationId || null : null;
async function getIosPushNotificationServiceEnvironmentAsync() {
  if (!ExpoApplication_default.getPushNotificationServiceEnvironmentAsync) {
    throw new UnavailabilityError("expo-application", "getPushNotificationServiceEnvironmentAsync");
  }
  return await ExpoApplication_default.getPushNotificationServiceEnvironmentAsync();
}
...
Object.defineProperties(constants, {
  ...
  expoGoConfig: {
    get() {
      ...
      if (isExpoUpdatesManifest(maybeManifest)) {
        return ((_a3 = maybeManifest.extra) == null ? void 0 : _a3.expoGo) ?? null;
      } else if (isEmbeddedManifest(maybeManifest)) {
        return maybeManifest;
      }
      return null;
  ...
  easConfig: {
    get() {
      ...
      if (isExpoUpdatesManifest(maybeManifest)) {
        return ((_a3 = maybeManifest.extra) == null ? void 0 : _a3.eas) ?? null;
      } else if (isEmbeddedManifest(maybeManifest)) {
        return maybeManifest;
      }
      return null;
...
// node_modules/expo-notifications/build/ServerRegistrationModule.js
var ServerRegistrationModule_default = {
  addListener: () => {
  },
  removeListeners: () => {
  }
...
var tokenEmitter = new EventEmitter(PushTokenManager_default);
var newTokenEventName = "onDevicePushToken";
function addPushTokenListener(listener) {
  const wrappingListener = ({ devicePushToken }) => listener({ data: devicePushToken, type: Platform_default2.OS });
...
var import_backoff = __toESM(require_backoff());
...
async function updateDevicePushTokenAsync(signal, token) {
  ...
  let nextBackoffInterval = (0, import_backoff.computeNextBackoffInterval)(initialBackoff, retriesCount, backoffOptions);
  while (shouldTry && !signal.aborted) {
    shouldTry = false;
    await doUpdateDevicePushTokenAsync(retry);
    if (shouldTry && !signal.aborted) {
      nextBackoffInterval = (0, import_backoff.computeNextBackoffInterval)(initialBackoff, retriesCount, backoffOptions);
      retriesCount += 1;
...
async function getDeviceIdAsync() {
  try {
    if (!ServerRegistrationModule_default.getInstallationIdAsync) {
      throw new UnavailabilityError("ExpoServerRegistrationModule", "getInstallationIdAsync");
    }
    return await ServerRegistrationModule_default.getInstallationIdAsync();
  } catch (e) {
...
async function setAutoServerRegistrationEnabledAsync(enabled) {
  lastAbortController == null ? void 0 : lastAbortController.abort();
  if (!ServerRegistrationModule_default.setRegistrationInfoAsync) {
    throw new UnavailabilityError("ServerRegistrationModule", "setRegistrationInfoAsync");
  }
  await ServerRegistrationModule_default.setRegistrationInfoAsync(enabled ? JSON.stringify({ isEnabled: enabled }) : null);
}
...
if (ServerRegistrationModule_default.getRegistrationInfoAsync) {
  addPushTokenListener(async (token) => {
    try {
      const registrationInfo = await ServerRegistrationModule_default.getRegistrationInfoAsync();
      if (!registrationInfo) {
        return;
      }
  ...
  ServerRegistrationModule_default.getRegistrationInfoAsync().then(__handlePersistedRegistrationInfoAsync);
} else {
...
async function getExpoPushTokenAsync(options = {}) {
  ...
  const projectId = options.projectId || ((_a3 = Constants_default.easConfig) == null ? void 0 : _a3.projectId);
  if (!projectId) {
...
// node_modules/expo-notifications/build/presentNotificationAsync.js
var warningMessageShown = false;
async function presentNotificationAsync(content, identifier = uuid_default.v4()) {
  ...
  if (!NotificationPresenterModule_default.presentNotificationAsync) {
    throw new UnavailabilityError("Notifications", "presentNotificationAsync");
  }
  return await NotificationPresenterModule_default.presentNotificationAsync(identifier, content);
}
...
// node_modules/expo-notifications/build/BadgeModule.js
var BadgeModule_default = {
  addListener: () => {
  },
  removeListeners: () => {
  }
...
async function getBadgeCountAsync() {
  if (!BadgeModule_default.getBadgeCountAsync) {
    throw new UnavailabilityError("ExpoNotifications", "getBadgeCountAsync");
  }
  return await BadgeModule_default.getBadgeCountAsync();
}

// node_modules/expo-notifications/build/setBadgeCountAsync.js
async function setBadgeCountAsync(badgeCount, options) {
  if (!BadgeModule_default.setBadgeCountAsync) {
    throw new UnavailabilityError("ExpoNotifications", "setBadgeCountAsync");
  }
  return await BadgeModule_default.setBadgeCountAsync(badgeCount, options == null ? void 0 : options[Platform_default2.OS]);
}
...
async function scheduleNotificationAsync(request) {
  ...
  return await NotificationScheduler_default.scheduleNotificationAsync(request.identifier ?? uuid_default.v4(), request.content, parseTrigger(request.trigger));
}
var DAILY_TRIGGER_EXPECTED_DATE_COMPONENTS = [
  "hour",
  "minute"
];
var WEEKLY_TRIGGER_EXPECTED_DATE_COMPONENTS = [
  "weekday",
  "hour",
  "minute"
];
var YEARLY_TRIGGER_EXPECTED_DATE_COMPONENTS = [
  "day",
  "month",
  "hour",
  "minute"
...
function isSecondsPropertyMisusedInCalendarTriggerInput(trigger) {
  ...
  return (
    ...
    "seconds" in triggerWithoutChannelId && "repeats" in triggerWithoutChannelId && Object.keys(triggerWithoutChannelId).length > 2 || // eg. { seconds: ..., hour: ... }
    "seconds" in triggerWithoutChannelId && !("repeats" in triggerWithoutChannelId) && Object.keys(triggerWithoutChannelId).length > 1
  );
}
...
var emitter = new EventEmitter(NotificationsEmitterModule_default);
...
async function getLastNotificationResponseAsync() {
  if (!NotificationsEmitterModule_default.getLastNotificationResponseAsync) {
    throw new UnavailabilityError("ExpoNotifications", "getLastNotificationResponseAsync");
  }
  const response = await NotificationsEmitterModule_default.getLastNotificationResponseAsync();
...
async function clearLastNotificationResponseAsync() {
  if (!NotificationsEmitterModule_default.clearLastNotificationResponseAsync) {
    throw new UnavailabilityError("ExpoNotifications", "getLastNotificationResponseAsync");
  }
  await NotificationsEmitterModule_default.clearLastNotificationResponseAsync();
...
function useLastNotificationResponse() {
  const [lastNotificationResponse, setLastNotificationResponse] = (0, import_react4.useState)(void 0);
  ...
  (0, import_react4.useLayoutEffect)(() => {
    var _a3;
    (_a3 = getLastNotificationResponseAsync) == null ? void 0 : _a3().then((response) => setLastNotificationResponse((prevResponse) => newResponseIfNeeded(prevResponse, response)));
    ...
    const clearResponseSubscription = addNotificationResponseClearedListener(() => {
      setLastNotificationResponse(void 0);
    });
    return () => {
      subscription.remove();
...
var notificationEmitter = new EventEmitter(NotificationsHandlerModule_default);
  ...
  if (handler) {
    handleSubscription = notificationEmitter.addListener(handleNotificationEventName, async ({ id, notification }) => {
      ...
      if (!NotificationsHandlerModule_default.handleNotificationAsync) {
        (_a3 = handler.handleError) == null ? void 0 : _a3.call(handler, id, new UnavailabilityError("Notifications", "handleNotificationAsync"));
        return;
      }
      try {
    ...
    handleTimeoutSubscription = notificationEmitter.addListener(handleNotificationTimeoutEventName, ({ id, notification }) => {
      var _a3;
      return (_a3 = handler.handleError) == null ? void 0 : _a3.call(handler, id, new NotificationTimeoutError(id, notification));
    });
  }
}
  ...
  if (typeof Notification.requestPermission !== "undefined") {
    ...
    if (shouldAsk) {
      status = await new Promise((resolve, reject) => {
        ...
        (_b = (_a4 = Notification.requestPermission(resolveOnce)) == null ? void 0 : _a4.then(resolveOnce)) == null ? void 0 : _b.catch(reject);
      });
    }
    return convertPermissionStatus(status);
  } else if (typeof navigator !== "undefined" && ((_a3 = navigator == null ? void 0 : navigator.permissions) == null ? void 0 : _a3.query)) {
...
var usePermissions = createPermissionHook({
...
(function(AndroidImportance2) {
  ...
  AndroidImportance2[AndroidImportance2["DEEFAULT"] = 5] = "DEEFAULT";
